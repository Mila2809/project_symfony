 ...
 */
final class Version20241227223624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contenu_panier (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, commandes_id INT DEFAULT NULL, quantite INT DEFAULT NULL, INDEX IDX_80507DC0F347EFB (produit_id), INDEX IDX_80507DC08BF5C2E6 (commandes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE contenu_panier ADD CONSTRAINT FK_80507DC08BF5C2E6 FOREIGN KEY (commandes_id) REFERENCES commandes (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contenu_panier DROP FOREIGN KEY FK_80507DC08BF5C2E6');
